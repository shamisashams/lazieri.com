...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{ __('admin.partners')}}</span>
        </div>
    ...
    <!-- /breadcrumb -->
    <input name="old-images[]" id="old_images" hidden disabled value="{{$partners}}">
    <!-- row -->
                            ...
                            @foreach($partners as $item)
                                ...
                                <div class="uploaded-image">
                                    ...
                                    <div style="position: absolute;z-index: 10;background-color: #fff">
                                        ...
                                        <input class="form-control" type="text" name="company_name[{{$item->id}}]" value="{{$item->company_name}}" placeholder="Company name">
