                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="{{$locale.'[description]'}}">{{$category->translate($locale)->description ?? ''}}</textarea>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="actions" style="display: none;">
                        <button id="cropBtn" type="button">Crop @if($category->created_at)& Upload @endif</button>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="image-uploader">
                        <div class="uploaded">
                            ...
                            @foreach($category->files as $item)
    ...
    <script>
        ...
        cropBtn.addEventListener('click', () => {
            ...
            croppie.result({
                ...
                fetch('{{route('category.crop-upload',$category)}}', {
                    method: 'POST',
                    body: formData
                }).then(() => {
                    location.reload()
