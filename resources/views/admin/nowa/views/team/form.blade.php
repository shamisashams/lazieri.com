...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$model->created_at ? __('admin.team-update') : __('admin.team-create')}}</span>
        </div>
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            ...
                                            <div class="form-group">
                                                {!! Form::label($locale.'[name]',__('admin.name'),['class' => 'form-label']) !!}
                                                {!! Form::text($locale.'[name]',$model->translate($locale)->name ?? '',['class' => 'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                {!! Form::label($locale.'[surname]',__('admin.surname'),['class' => 'form-label']) !!}
                                                {!! Form::text($locale.'[surname]',$model->translate($locale)->surname ?? '',['class' => 'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                {!! Form::label($locale.'[position]',__('admin.position'),['class' => 'form-label']) !!}
                                                {!! Form::text($locale.'[position]',$model->translate($locale)->position ?? '',['class' => 'form-control']) !!}
    ...
    <script>
        ...
        cropBtn.addEventListener('click', () => {
            ...
            croppie.result({
                ...
                {{--@if($model->created_at)
                fetch('{{route('team.crop-upload',$model)}}', {
                    method: 'POST',
                    body: formData
                }).then(() => {
                    location.reload()
