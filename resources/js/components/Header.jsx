    ...
    function handleSearch(e) {
        ...
        interval = setTimeout(function () {
            if (e.target.value.length > 0) {
                axios
                    .post(route("search.index"), { term: e.target.value })
                ...
                <div className="mt-5 flex  justify-between ">
                    ...
                    >
                        ...
                        <li className="pb-8 cursor-pointer  md:inline-block font-bold mr-8 group ">
                            ...
                            <div className="md:whitespace-nowrap invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 absolute z-10 pt-4 pb-2 md:-left-10 left-36  md:group-hover:left-0 md:bottom-5 md:top-auto top-0 font-normal text-sm ">
                        ...
                        <li className="pb-8  md:inline-block font-bold mr-8">
                            <Link href={route("client.service.index")}>
                                {__("client.nav_service", localizations)}
                            </Link>
                        </li>
                        <li className="pb-8  md:inline-block font-bold mr-8">
                            <Link href={route("client.partner.index")}>
                                {__("client.nav_partners", localizations)}
                            </Link>
                        </li>
                        <li className="pb-8 md:inline-block font-bold mr-8">
                                ...
                                return (
                                    <div className="inline-block mr-5 mb-10">
                                        ...
                                        <Link
                                            ...
                                            className="block mb-1 opacity-70"
                                        >
                                            {item.text_1}
                                        </Link>
